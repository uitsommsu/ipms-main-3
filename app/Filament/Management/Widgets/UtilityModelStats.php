...
class UtilityModelStats extends BaseWidget
{
    protected ?string $heading = 'Utility Model Analytics';

    protected ?string $description = 'An overview of Utility Models analytics.';
